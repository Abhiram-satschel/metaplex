import {
  ...
  async function main() {
    ...
    const myKeypair = loadWalletKey(
      "mepAMcUjEzjsPXJCAz15sqbXsSCbWdUBvQ4MtvSYS4v.json"
    );
    const mint = new web3.PublicKey(
      "toWbSiRR8x244RUcq4c6zt7RWGX2q22WGmLTmRXJyfe"
    );
    ...
    const ourMetadata = {
      ...
      name: "Shankar",
      symbol: "SHIV",
      uri: "https://raw.githubusercontent.com/standardTokens/main/metadata.json",
    };
